...
interface WinningBingoCardProps {
  open: boolean;
  onClose: () => void;
  headers: string[];
  columns: Array<Array<string | number>> | null;
  selected: boolean[][] | null;
}

export default function WinningBingoCard({ open, onClose, headers, columns, selected }: WinningBingoCardProps) {
  if (!open) return null;
  return (
        ...
        <div className="flex flex-col items-center w-full">
          ...
          <div className="flex justify-center w-full mb-2">
            <div className="grid grid-cols-5 gap-2">
              ...
              {[0, 1, 2, 3, 4].flatMap((rowIdx: number) =>
                columns && columns.map((col: Array<string | number>, colIdx: number) => {
